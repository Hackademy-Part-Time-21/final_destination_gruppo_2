            <div class="col-md-4 mb-3"> 
                <div id="cardgeneric" class="justify-content-between m-3 ">
                <div class="card rounded-4 border border-dark-subtle bg-gradient-secondary border-4 border-opacity-50"> 
                    ...
                    <div class="card-body border p-0 rounded-3">
                        <h5 title="titolo" class=" truncateTitlecard-title fw-bold m-0 fs-5 border border-end-0 border-start-0 border-top-0 border-3 blueColorText p-2">{{ $ad->title }}</h5>
                        <br>
                        <p title="descrizione" class=" truncateDescription card-text fw-semibold border border-end-0 border-start-0 border-top-0 border-2 p-1">{{ $ad->description }}</p>
