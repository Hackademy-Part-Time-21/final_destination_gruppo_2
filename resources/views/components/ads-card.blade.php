<div class="col-md-3 mb-4 "> 
    ...
    <div class="card rounded-4 border border-dark-subtle bg-gradient-secondary border-4 border-opacity-50 backgroundOpacity"> 
        ...
        <div class="card-body border p-0 rounded-3 ">
            ...
            <a href="{{route('adDetail',$ad->id)}}" class="btn btn-success border border-black m-2 footerColor">Dettagli</a>
        </div>
    </div>
</div>
</div>